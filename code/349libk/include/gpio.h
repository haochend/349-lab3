...
/** @brief Get the level of a GPIO pin (low or high)
 *
 *  @param pin Pin number to get the level of (0 to 53 on pi)
 *  @return The level of the pin, -1 on error
 */
int8_t gpio_get_level(uint8_t pin);
#endif /* _GPIO_H_ */