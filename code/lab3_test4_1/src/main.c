...
int main(void) {
  ...
  status += thread_create(&thread_1, &thread1_stack[USR_STACK_WORDS-1],
          1, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_2, &thread2_stack[USR_STACK_WORDS-1],
          2, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_3, &thread3_stack[USR_STACK_WORDS-1],
          3, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_4, &thread4_stack[USR_STACK_WORDS-1],
          4, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_5, &thread5_stack[USR_STACK_WORDS-1],
          5, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_6, &thread6_stack[USR_STACK_WORDS-1],
          6, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_7, &thread7_stack[USR_STACK_WORDS-1],
          7, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_8, &thread8_stack[USR_STACK_WORDS-1],
          8, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_9, &thread9_stack[USR_STACK_WORDS-1],
          9, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_10, &thread10_stack[USR_STACK_WORDS-1],
          10, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_11, &thread11_stack[USR_STACK_WORDS-1],
          11, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_12, &thread12_stack[USR_STACK_WORDS-1],
          12, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_13, &thread13_stack[USR_STACK_WORDS-1],
          13, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_14, &thread14_stack[USR_STACK_WORDS-1],
          14, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_15, &thread15_stack[USR_STACK_WORDS-1],
          15, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_16, &thread16_stack[USR_STACK_WORDS-1],
          16, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_17, &thread17_stack[USR_STACK_WORDS-1],
          17, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_18, &thread18_stack[USR_STACK_WORDS-1],
          18, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_19, &thread19_stack[USR_STACK_WORDS-1],
          19, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_20, &thread20_stack[USR_STACK_WORDS-1],
          20, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_21, &thread21_stack[USR_STACK_WORDS-1],
          21, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_22, &thread22_stack[USR_STACK_WORDS-1],
          22, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_23, &thread23_stack[USR_STACK_WORDS-1],
          23, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_24, &thread24_stack[USR_STACK_WORDS-1],
          24, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_25, &thread25_stack[USR_STACK_WORDS-1],
          25, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_26, &thread26_stack[USR_STACK_WORDS-1],
          26, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_27, &thread27_stack[USR_STACK_WORDS-1],
          27, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_28, &thread28_stack[USR_STACK_WORDS-1],
          28, THREAD_TIME_MS, THREAD_PERIOD);
  status += thread_create(&thread_29, &thread29_stack[USR_STACK_WORDS-1],
          29, THREAD_TIME_MS, THREAD_PERIOD);
